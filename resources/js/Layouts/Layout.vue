...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <button @click="pmenu" type="button" class="flex text-sm bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
        <span class="sr-only">Open user menu</span>
        <img class="w-8 h-8 rounded-full" src="/image/layout/home.png" alt="user photo">
      </button>
      <div class="relative inline-block text-left">

    <div v-if="profile.isOpen" class="absolute right-0 mt-2 w-48 bg-white shadow-lg rounded-md">
      <div class="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
        <a href="/profile" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Profile Page</a>
